...
Vandaag hebben we gewerkt aan leren over anchors en popover. Daarnaast heb ik binnen mijn groepje gewerkt aan de presentatie hierover. Ocean heeft gewerkt aan een planetarium, te zien in de onderstaande figuur.

![Planetarium](/docs/week-1-presentatie-ocean.gif)

Dit werkt met behulp van anchoring om de aarde om de zon te laten draaien en de maan om de aarde. Jean-Carlos heeft gewerkt aan een website die een hobby koppelt aan de juiste persoon, zoals te zien in de volgende figuur.

![Hobby linker](/docs/week-1-presentatie-jean-carlos.gif)

Ook dit werkt met behulp van anchoring om de hobbies aan de (roze) boxen te koppelen en als er op geklikt wordt om ze met een animatie aan een nieuwe anchor te koppelen (de profielfoto). Als laatste heb ik gewerkt aan een website die elk van onze huisdieren laat zien en met een popover kan op het dier geklikt worden om de naam van het huisdier en eigenaar te tonen. Ook mijn deel van de presentatie is te zien in de onderstaande figuur.

![Huisdier linker](/docs/week-1-presentatie-kerr.gif)

Ook hier is gebruik gemaakt van anchoring van het linken van het dier aan zijn eten, maar ook om de popover te linken aan het huisdier. Ik heb ook gebruik gemaakt van position fallbacks om de popovers te verplaatsen als er geen ruimte is voor de popover.

# Dagelijkse check-out donderdag 19/02

Vandaag heb ik tijdens de check-out met Justin besproken wat mijn plan is. Ik heb gekozen voor de Rubiks Cube opdracht. Omdat er vandaag niet veel tijd was om hieraan te werken heb ik enkel een beetje gerommeld met wat divs maken voor elke vlak van elk blokje (dus 54 divs in totaal, 6 zijden, 9 blokjes) en deze de correcte kleur geven. Dit duurde ongeveer een uurtje.

Ik heb tijdens de presentaties van andere groepen verschillende dingen geleerd. In het bijzonder heb ik geleerd over media queries, scroll driven development (en hoe je een SVG kan gebruiken als een path!) en carrousel.

Morgen wil ik nog verder nadenken over wat ik wil maken, zodat ik een beter idee heb wat ik na de vakantie ga doen. Waarschijnlijk ga ik in de vakantie als ik daar zin in heb nog wat spelen met de mogelijkheden van CSS.
